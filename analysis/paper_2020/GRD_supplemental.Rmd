...
ratings_pairs <- read.csv(here("analysis","paper_2020","processed_data","ratings_item_pairs.csv"))
...
drsq_pn_a_ec <- read.csv(here("analysis","paper_2020","processed_data","drsqr_pn_a_ec.csv"))
...
```{r rating data prep}
library(gmodels)
raw_ratings <- read.csv(here("analysis","paper_2020","processed_data","ratings_raw.csv"))
